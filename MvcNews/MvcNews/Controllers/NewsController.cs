...
namespace MvcNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        {
            var model = new NewsItem() { TimeStamp = System.DateTime.Now };
            return View(model);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,TimeStamp,Text,RowVersion")] NewsItem newsItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "The record you attempted to edit was modified by another user after you got the original value. Your operation was cancelled");
                        return View(newsItem);
                    }
                }
                return RedirectToAction(nameof(Index));
